...
<p align="center">
  ...
  <!-- <a href="PORTFOLIO_URL_HERE"><img src="https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=vercel&logoColor=white" alt="Portfolio"/></a> -->
</p>
...
I'm a detail-oriented **Software Engineer** focused on **front-end development**, with hands-on experience building modern, responsive web applications and a growing toolkit across mobile and AI.

- 🔭 Currently working as a **Frontend Developer Intern at IDATA Technologies** (since April 2026)
- 🎓 Pursuing a **B.Sc. in Computer Software Engineering** at *Addis Ababa Science and Technology University*
- 💻 I build with **React, Next.js, TypeScript, Python (Django), and PHP**
- 📱 Exploring **mobile development with Flutter**
- 🤖 Diving into **Machine Learning & Artificial Intelligence**
- 🌱 Always learning — driven by clean code, user-centric design, and solving real problems
...
- **ALX Professional Foundations** — ALX Africa, Apr 2025
- **ALX ProDev: Front-End Development** — ALX Africa, Oct 2025
...
`Collaboration & Teamwork` · `Communication` · `Adaptability` · `Attention to Detail` · `Self-Motivation` · `Project Planning` · `Critical Thinking` · `Time Management`
...
<p align="center"><i>Open to challenging software developer roles where I can build great products and keep growing. Let's connect!</i></p>
